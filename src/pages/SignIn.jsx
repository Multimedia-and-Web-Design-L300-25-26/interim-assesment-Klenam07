				...
				<div className="w-full max-w-[390px]">
					...
					{step === 'email' && (
						<form onSubmit={handleEmailContinue}>
							<h1 className="text-[1.75rem] font-bold text-white mb-3">Sign in to Coinbase</h1>
					...
					{step === 'password' && (
						<form onSubmit={handlePasswordContinue}>
							...
							<button
								...
								className="w-full h-14 rounded-full bg-[#3B4DE0] hover:bg-[#2F3FC0] active:bg-[#2535A0] disabled:bg-[#2C2F36] disabled:cursor-not-allowed text-white font-semibold text-[0.9375rem] transition-colors"
							>
